  ...
  <body class="page-header-fixed sidebar-nav bg-1">
    <div class="modal-shiftfix">
        ...
        <div class="container-fluid main-content">
              <?php
                echo showHomeMenu($empname);
                echo showToDoList($_SESSION["empid"]);
                if($access==1 || $access==3){
                  echo showCurrentBrand($empname,$access);
                  echo showweeklyproducts($empname,$access);
                }
                if($access==1){
                  echo showImageRename($empname,$access);
                }
              ?>
        </div>
